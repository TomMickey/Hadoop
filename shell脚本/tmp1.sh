	...
	FROM 
		...
		FROM 
			...
			FROM 
					...
					FROM 
						...
						FROM 
							...
							FROM 
								...
								WHERE concat(deal_year,deal_month,deal_day)>='20180601
										AND concat(deal_year,deal_month,deal_day)<='20180831
										AND isdn <> '' ) a1
								JOIN 
				...
				GROUP BY  a7.year,a7.month,a7.day,a7.area_de,a7.isdn,a7.max_time,a7.min_time,a7.num 
		) a8;
"